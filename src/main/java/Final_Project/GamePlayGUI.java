...
public class GamePlayGUI extends JFrame {
    ...
    public winnerObject winner () {
        ...
        //pass the winning object to populateLeaderboard
        populateLeaderBoard(winScore);
        return winScore;
    }

    public void populateLeaderBoard (winnerObject winScore){
        //pass to store in database table leaderBoard
        wordController.addWinScore(winScore);
    }
